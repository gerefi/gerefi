/** \file gerefi.h
 * @brief gerefi main file containing initial setup and system loop functions 
 * @author Josh Stewart
 * 
 * This file contains the main system loop of the gerefi core and thus much of the logic of the fuel and ignition algorithms is contained within this
